# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-14 22:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memory_size', models.PositiveSmallIntegerField(help_text='Put values in MB, eg.: 512, 1024...', verbose_name='Memory size')),
                ('disk_size', models.PositiveSmallIntegerField(help_text='Put values in GB, eg.: 20, 40...', verbose_name='Disk size')),
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=10, verbose_name='Price')),
            ],
        ),
    ]
